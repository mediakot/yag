 ...
 * @package evoWGrid
 */
class eWGrid extends Plugin
{
    public $pluginName = 'evoWGrid';
    public $tpl = 'assets/plugins/evoWGrid/tpl/template.tpl';
    public $emptyTpl = 'assets/plugins/evoWGrid/tpl/empty.tpl';
    public $jsListDefault = 'assets/plugins/evoWGrid/js/scripts.json';
    public $cssListDefault = 'assets/plugins/evoWGrid/css/styles.json';
    public $cssListCustom = 'assets/plugins/evoWGrid/css/custom.json';
    public $_lang = array();
    public $id = '';
...
public function __construct($modx, $lang_attribute = 'en', $_lang)
    {
        ...
        $this->langExtend();
        $this->tableHeader();
        //$this->modx->logEvent(123, 1, var_export(,true) , 'Test core evoWGrid');
    }
    ...
    public function getTplPlaceholders()
        {
            ...
            $ph = array(
                ...
                'url'          => $this->modx->config['site_url'] . 'assets/plugins/evoWGrid/ajax.php',
