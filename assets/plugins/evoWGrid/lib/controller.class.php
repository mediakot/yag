...
require_once(MODX_BASE_PATH . 'assets/plugins/evoWGrid/lib/table.class.php');
use \SimpleTab\AbstractController;
/**
 * Class evoWGController
 * @package evoWGrid
 */

//$this->modx->logEvent(123, 1, var_export($out,true) , 'Test evoWGrid controller');
class evoWGController extends AbstractController
{
	public $rfName = 'id';
	...
	public function __construct(\DocumentParser $modx)
	    {
	        ...
	        $this->data = new eWGData($this->modx);
	...
	public function setMultiData(){
		//$this->modx->logEvent(123, 1, var_export($_POST['data'],true) , 'Test evoWGrid controller');
