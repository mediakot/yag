<div id="evoWGrid" class="tab-page">
<h2 class="tab" id="wgrid-tab">[+tabName+]</h2>
<div id="tableW" style="width:100%; margin:10px; border:1px solid #ccc"></div>
</div>
...
function to_json(workbook) {
		...
		(function($){
			var loaded = false;
		    $('#documentPane').on('click','#wgrid-tab',function(){
		        if(!loaded){
		    ...
		    $(window).on('load', function(){
		        if ($('#wgrid-tab')) {
		            $('#wgrid-tab.selected').trigger('click');
		        }
		    });
